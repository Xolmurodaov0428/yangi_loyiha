        ...
        <div class="card-body">
            <form method="GET" class="row g-3">
                ...
                <div class="col-md-4 d-flex align-items-end">
                    ...
                    <a href="{{ route('admin.students.attendance') }}" class="btn btn-outline-secondary">
                    ...
                    <div class="row g-3 mb-4">
                        @forelse($groups as $group)
                            <div class="col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3">
                                <div class="card border-0 shadow-sm {{ $selectedGroup && $selectedGroup->id === $group->id ? 'border border-success border-2' : '' }}" style="transition: all 0.3s ease; cursor: pointer; min-height: 140px;" onclick="window.location.href='{{ route('admin.students.attendance', ['group_id' => $group->id, 'date' => $date]) }}'">
...
<div class="modal fade" id="attendanceModal" tabindex="-1" aria-labelledby="attendanceModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form id="attendanceForm" method="POST" action="{{ route('admin.students.attendance.mark') }}">
                @csrf
...
function viewStudentAttendance(studentId, date, studentNameFromBtn) {
    ...
    // AJAX orqali davomat tarixini yuklash (named route orqali URL)
    const historyUrlTemplate = "{{ route('admin.students.attendance.history', ['studentId' => 'STUDENT_ID_PLACEHOLDER']) }}";
